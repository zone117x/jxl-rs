...
///
/// Note: This assumes BT.2020 primaries. The tone mapping stage runs
/// before CMS conversion, so input is in the image's native primaries
/// (typically BT.2020 for HDR PQ/HLG content).
