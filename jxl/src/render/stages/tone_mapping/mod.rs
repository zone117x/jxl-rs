...
///
/// For BT.2446a methods, output 1.0 = source peak (scene-referred normalization preserved).
/// For Rec2408, output 1.0 = target peak (matching libjxl convention).
#[derive(Debug)]
enum ToneMappingParams {
    Bt2446a(common::Bt2446aParams),
    Rec2408(rec2408::Rec2408Params),
}
...
impl ToneMappingStage {
    pub fn new(
        ...
        let params = match method {
            ...
            | JxlToneMappingMethod::Bt2446aPerceptual => ToneMappingParams::Bt2446a(
                common::Bt2446aParams::new(source_intensity_target, desired_intensity_target),
            ),
            JxlToneMappingMethod::Rec2408 => {
                ToneMappingParams::Rec2408(rec2408::Rec2408Params::new(
    ...
    fn bt2446a(&self) -> &common::Bt2446aParams {
        match &self.params {
            ToneMappingParams::Bt2446a(p) => p,
            _ => unreachable!(),
        }
    }

    fn rec2408(&self) -> &rec2408::Rec2408Params {
        match &self.params {
            ToneMappingParams::Rec2408(p) => p,
            _ => unreachable!(),
        }
    }
}
...
impl RenderPipelineInPlaceStage for ToneMappingStage {
    ...
    fn process_row_chunk(
        ...
        match self.method {
            ...
            JxlToneMappingMethod::Rec2408 => {
                rec2408::process_row(self, xsize, row_r, row_g, row_b);
            }
        }
    }
}
